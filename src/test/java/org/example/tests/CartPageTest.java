...
public class CartPageTest extends BaseDriver {
    ...
    public void start(){
        ...
        parentTest = report.createTest("<p style=\"color:#FF6000; font-size:20px\"><b>Cart Page</b></p>");
    }

    @Test
    public void cartTest() throws IOException {
        childTest = parentTest.createNode("<p style=\"color:#3E96E7; font-size:20px\"><b>CartPage TEST</b></p>");
