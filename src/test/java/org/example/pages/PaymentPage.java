...
public class PaymentPage {
    ...
    ExtentTest test;
    public PaymentPage(ExtentTest test){
    ...
    public void PAYMENT() throws IOException {
        try {
            ...
            test.info("click creditcard button");
            if (creditcard.isDisplayed()) {
                actions.moveToElement(creditcard).build().perform();
                creditcard.click();
                Thread.sleep(5000);
                passCaseWithSC("clicked creditcard", "clicked creditcard successful");
            ...
            failCase("Unable to locate creditcard", "creditcardfail");
        }
